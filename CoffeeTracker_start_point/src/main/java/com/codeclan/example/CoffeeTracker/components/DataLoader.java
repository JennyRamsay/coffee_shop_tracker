...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        Coffee coffee1 = new Coffee("Magnum Exotics", 15, 1728, coffeeShop1);
        ...
        Coffee coffee2 = new Coffee("Volcanica Brazil Peaberry", 12, 1770, coffeeShop2);
        ...
        Coffee coffee3 = new Coffee("Juan Valdez", 6, 1835, coffeeShop3);
        ...
        Coffee coffee4 = new Coffee("Magnum Exotics", 12, 1728, coffeeShop1);
        ...
        Coffee coffee5 = new Coffee("Cumbres del Poas Coffee", 12, 1779, coffeeShop5);
        ...
        Coffee coffee6 = new Coffee("Volcanica", 16, 1779, coffeeShop5);
        coffeeRepository.save(coffee6);

        Coffee coffee7 = new Coffee("Green Coffee Trader", 12, 1728, coffeeShop6);
        coffeeRepository.save(coffee7);

        Coffee coffee8 = new Coffee("Old Pulteney 18", 18, 1728, coffeeShop6);
        ...
        Coffee coffee9 = new Coffee("Coffee Traders One-Hundred Percent", 12, 1728, coffeeShop7);
        coffeeRepository.save(coffee9);

        Coffee coffee10 = new Coffee("Dancing Moon", 13, 1728, coffeeShop7);
        ...
        Coffee coffee11 = new Coffee("Cooper's Cask Brazilian Espresso Cremoso", 15, 1770, coffeeShop8);
        coffeeRepository.save(coffee11);

        Coffee coffee12 = new Coffee("Pilao Coffee Traditional Roast and Ground", 10, 1770, coffeeShop8);
        ...
        Coffee coffee13 = new Coffee("Yirgacheffe Coffee", 16, 1500, coffeeShop9);
        coffeeRepository.save(coffee13);

        Coffee coffee14 = new Coffee("Organic Sidamo Coffee", 1, 1500, coffeeShop9);
        ...
        Coffee coffee15 = new Coffee("Peet's Coffee Brazil Minas Naturais Ground Coffee", 16, 1770, coffeeShop8);
        coffeeRepository.save(coffee15);

        Coffee coffee16 = new Coffee("Dancing Moon", 1, 1728, coffeeShop7);
        ...
        Coffee coffee17 = new Coffee("Tarrazu Coffee", 1, 1779, coffeeShop11);
        coffeeRepository.save(coffee17);

        Coffee coffee18 = new Coffee("Monteverde Coffee", 1, 1779, coffeeShop11);
        ...
        Coffee coffee19 = new Coffee("La Minita Coffee", 13, 1779, coffeeShop12);
        coffeeRepository.save(coffee19);

        Coffee coffee20 = new Coffee("La Amistad Coffee", 1, 1779, coffeeShop12);
        ...
        Coffee coffee21 = new Coffee("Don Pablo", 12, 1835, coffeeShop13);
        coffeeRepository.save(coffee21);

        Coffee coffee22 = new Coffee("Colombia Coffee Roasters", 18, 1835, coffeeShop13);
